...
--{ Globals
local DiscordInvite = UiLibrary.LFlags["Invite"] or ["", ""]
local Util = {}
...
if UiLibrary.LFlags["DirectoryStructure"] then
    CreateDirectory(UiLibrary.LFlags["DirectoryStructure"]) 
end
    ...
    local Viewport = Util:New(
        ...
        },
        {
                    ...
                    Util:New(
                        "UIGradient",
                        {
                            Color = ColorSequence.new{
                                ColorSequenceKeypoint.new(0, Color3.new(255, 0, 0)),
                                ColorSequenceKeypoint.new(1, Color3.new(255, 0, 0))
                            },
                            Rotation = 180,
            ...
            Util:New(
                ...
                {
                    Name = "Window",
                    BackgroundColor3 = DefaultTheme.Tertiary,
                                    ...
                                    Util:New(
                                        ...
                                        },
                                        {
                                            Util:New(
                                                "UIPadding",
                                                {
                                                    PaddingBottom = Vector2.new(0, 1),
                                                    PaddingRight = Vector2.new(0, 8)
                                                }
                                            )
                                        }
                                    ),
